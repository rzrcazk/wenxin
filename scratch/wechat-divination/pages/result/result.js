    ...
    onShareAppMessage() {
        if (this.data.isKnowledge) {
             return {
                ...
                path: `/pages/result/result?type=KNOWLEDGE&question=${encodeURIComponent(this.data.question)}`
            };
        }
        ...
        return {
            ...
            path: `/pages/result/result?lines=${linesStr}&question=${question}&complexity=${complexity}`
        };
    },
