...
const { generateCoinStandingMessage, preloadSummary } = require('../../utils/ai_super.js');
...
Page({
    ...
    goToResult() {
        ...
        wx.navigateTo({
            url: `../result_super/result_super?lines=${linesStr}&question=${question}&complexity=${this.complexity}`
        });
    },
